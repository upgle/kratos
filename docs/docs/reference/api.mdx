...
<a id="initialize-login-flow-for-native-apps-and-api-clients-parameters"></a>
...
<a id="initialize-login-flow-for-native-apps-and-api-clients-responses"></a>
...
<a id="opIdinitializeSelfServiceRecoveryForNativeApps"></a>
...
<a id="initialize-recovery-flow-for-native-apps-and-api-clients-responses"></a>
...
<a id="opIdinitializeSelfServiceRegistrationForNativeApps"></a>
...
<a id="initialize-registration-flow-for-native-apps-and-api-clients-responses"></a>
...
<a id="opIdinitializeSelfServiceSettingsForNativeApps"></a>
...
<a id="initialize-settings-flow-for-native-apps-and-api-clients-parameters"></a>
...
<a id="initialize-settings-flow-for-native-apps-and-api-clients-responses"></a>
...
<a id="opIdinitializeSelfServiceVerificationForNativeApps"></a>
...
<a id="initialize-verification-flow-for-native-apps-and-api-clients-responses"></a>
...
<aside class="warning">
  To perform this operation, you must be authenticated by means of one of the
  following methods: sessionCookie
</aside>
...
curl -X GET /sessions/whoami \
  -H 'Accept: application/json' \  -H 'X-Session-Token: string'
```
...
| value    | [uiNodeInputAttributesValue](#schemauinodeinputattributesvalue) | false    | none         | The input's value.                                |

<a id="tocSuinodeinputattributesvalue"></a>

#### uiNodeInputAttributesValue

<a id="schemauinodeinputattributesvalue"></a>
